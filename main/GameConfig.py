...
LOADING_IMAGE3 = os.path.join(CURRENT_DIR, "..", "images", "game_loading3.png")
LOADING_IMAGE4 = os.path.join(CURRENT_DIR, "..", "images", "game_loading4.png")
...
# 开始/暂停游戏图片
PAUSE_NOR = os.path.join(CURRENT_DIR, "..", "images", "pause_nor.png")
PAUSE_PRESSED = os.path.join(CURRENT_DIR, "..", "images", "pause_pressed.png")
RESUME_NOR = os.path.join(CURRENT_DIR, "..", "images", "resume_nor.png")
RESUME_PRESSED = os.path.join(CURRENT_DIR, "..", "images", "resume_pressed.png")
...
# 超级炸弹
BOMB_IMAGE = os.path.join(CURRENT_DIR, "..", "images", "bomb.png")

# 补给(超级子弹/超级炸弹)
PROP1_IMAGE = os.path.join(CURRENT_DIR, "..", "images", "prop_type_0.png")
PROP2_IMAGE = os.path.join(CURRENT_DIR, "..", "images", "prop_type_1.png")
...
# 我方飞机生命图片
LIFE_IMAGE = os.path.join(CURRENT_DIR, "..", "images", "life.png")


# 结束游戏图片
GAMEOVER_IMAGE = os.path.join(CURRENT_DIR, "..", "images", "quit_nor.png")
# 重新开始游戏图片
RESTART_IMAGE = os.path.join(CURRENT_DIR, "..", "images", "restart_nor.png")
